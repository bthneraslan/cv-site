        ...
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block">
                <asp:Repeater ID="Repeater7" runat="server">
                    <ItemTemplate>
                        <%--<a href="Default.aspx">--%>
                            <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src='<%# Eval("FOTOGRAF") %>' alt=""><%--</a>--%>
                    </ItemTemplate>
                </asp:Repeater>
            </span>
        </a>
                ...
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5">
                            ...
                            <a href="mailto:bthneraslan@hotmail.com">-Mail :
                        ...
                        <div class="social-icons">
                            ...
                            <a href="www.facebook.com/bthneraslan">
